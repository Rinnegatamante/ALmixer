...
#	SET(CHIPMUNK_LIBRARY "${BLURRR_SDK_PATH}/chipmunk/libs/${ANDROID_ABI}/libchipmunk.so" CACHE STRING "Chipmunk library")
	...
	SET(OGG_INCLUDE_DIR "${BLURRR_SDK_PATH}/ogg/include" CACHE STRING "ogg include directory")
	SET(OGG_LIBRARY "${BLURRR_SDK_PATH}/ogg/libs/${ANDROID_ABI}/libogg.so" CACHE STRING "ogg library")

	SET(VORBIS_INCLUDE_DIR "${BLURRR_SDK_PATH}/vorbis/include" CACHE STRING "vorbis include directory")
	SET(VORBIS_LIBRARY "${BLURRR_SDK_PATH}/vorbis/libs/${ANDROID_ABI}/libvorbis.so" CACHE STRING "vorbis library")
	SET(VORBIS_FILE_LIBRARY "${BLURRR_SDK_PATH}/vorbis/libs/${ANDROID_ABI}/libvorbisfile.so" CACHE STRING "vorbisfilelibrary")

	SET(MPG123_INCLUDE_DIR "${BLURRR_SDK_PATH}/mpg123/include" CACHE STRING "mpg123 include directory")
	SET(MPG123_LIBRARY "${BLURRR_SDK_PATH}/mpg123/libs/${ANDROID_ABI}/libmpg123.so" CACHE STRING "mpg123 library")
