...
*/
	...
	#define SIMPLE_MUTEX_CONCAT(namespace, symbol) namespace##symbol
	#define SIMPLE_MUTEX_RENAME_PUBLIC_SYMBOL_WITH_NAMESPACE(namespace, symbol) SIMPLE_MUTEX_CONCAT(namespace, symbol)
