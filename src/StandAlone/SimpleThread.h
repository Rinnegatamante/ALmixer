...
*/
	...
	#define SIMPLE_THREAD_CONCAT(namespace, symbol) namespace##symbol
	#define SIMPLE_THREAD_RENAME_PUBLIC_SYMBOL_WITH_NAMESPACE(namespace, symbol) SIMPLE_THREAD_CONCAT(namespace, symbol)
