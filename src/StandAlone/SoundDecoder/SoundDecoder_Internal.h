...
#		else
#			extern void SoundDecoder_DebugPrint(const char* format, ...);
#			define SNDDBG(x) SoundDecoder_DebugPrint x
#		endif
#		define SNDDBG2(...) ((void)__android_log_print(ANDROID_LOG_DEBUG,  "ALmixer", __VA_ARGS__))
#	else
#		define SNDDBG(...)
#		define SNDDBG2(...)
#	endif
...
#	else
#		define SNDDBG(x) printf x
#		define SNDDBG2(...) printf(__VA_ARGS__)
#	endif
#else
#	define SNDDBG(x)
#	define SNDDBG2(...)
