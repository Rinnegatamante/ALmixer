...
/* This file contains portable memory management functions for ALmixer */

#include "ALmixer_stdinc.h"

#if defined(HAVE_MALLOC)

void *ALmixer_malloc(size_t size)
{
    return malloc(size);
}

void *ALmixer_calloc(size_t nmemb, size_t size)
{
    return calloc(nmemb, size);
}

void *ALmixer_realloc(void *ptr, size_t size)
{
    return realloc(ptr, size);
}

void ALmixer_free(void *ptr)
{
    free(ptr);
}
...
#define memset  ALmixer_memset
#define memcpy  ALmixer_memcpy
#define malloc  ALmixer_malloc
#define calloc  ALmixer_calloc
#define realloc ALmixer_realloc
#define free    ALmixer_free
