...
*/
	...
	#define CIRCULAR_QUEUE_CONCAT(namespace, symbol) namespace##symbol
	#define CIRCULAR_QUEUE_RENAME_PUBLIC_SYMBOL_WITH_NAMESPACE(namespace, symbol) CIRCULAR_QUEUE_CONCAT(namespace, symbol)
