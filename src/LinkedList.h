...
*/
	...
	#define LINKED_LIST_CONCAT(namespace, symbol) namespace##symbol
	#define LINKED_LIST_RENAME_PUBLIC_SYMBOL_WITH_NAMESPACE(namespace, symbol) LINKED_LIST_CONCAT(namespace, symbol)
