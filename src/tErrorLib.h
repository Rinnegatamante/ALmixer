...
*/
	...
	#define TERROR_CONCAT(namespace, symbol) namespace##symbol
	#define TERROR_RENAME_PUBLIC_SYMBOL_WITH_NAMESPACE(namespace, symbol) TERROR_CONCAT(namespace, symbol)
